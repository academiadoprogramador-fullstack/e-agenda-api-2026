...
public sealed class ServicoTarefaTests
{
    ...
    {
        var resultado = servico.Cadastrar(new("Publicar API", PrioridadeTarefa.Alta));
    ...
    {
        var resultado = servico.Cadastrar(new("A", PrioridadeTarefa.Normal));
    ...
    public void Editar_deve_alterar_titulo_e_prioridade_da_tarefa()
    {
        ...
        var resultado = servico.Editar(new(id, "Titulo novo", PrioridadeTarefa.Alta));
    ...
    public void AdicionarItem_deve_atualizar_tarefa_e_percentual()
    {
        ...
        var resultado = servico.AdicionarItem(new(tarefaId, "Criar controllers"));
    ...
    public void AdicionarItem_deve_rejeitar_item_invalido_sem_persistir()
    {
        ...
        var resultado = servico.AdicionarItem(new(tarefaId, "A"));
    ...
    public void AlterarConclusaoItem_deve_recalcular_percentual()
    {
        ...
        var resultado = servico.AlterarConclusaoItem(new(tarefaId, item.Id, true));
    ...
    public void AlterarConclusao_deve_rejeitar_tarefa_com_itens()
    {
        ...
        var resultado = servico.AlterarConclusao(new(tarefaId, true));
    ...
    public void RemoverItem_deve_persistir_tarefa_sem_item_removido()
    {
        ...
        var resultado = servico.RemoverItem(new(tarefaId, item.Id));
